<template>
    <div>
        <button :class="classes" class="tw-w-full tw-text-left" v-if="asButton">
            <slot></slot>
        </button>
...
<script>
    export default {
        ...
        computed: {
            classes() {
                return this.active
                            ? 'tw-block tw-pl-3 tw-pr-4 tw-py-2 tw-border-l-4 tw-border-indigo-400 tw-text-base tw-font-medium tw-text-indigo-700 tw-bg-indigo-50 focus:tw-outline-none focus:tw-text-indigo-800 focus:tw-bg-indigo-100 focus:tw-border-indigo-700 ttw-ransition tw-duration-150 tw-ease-in-out'
